    ...
    return (
      <div className="min-h-screen bg-dark-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading price comparison...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Compare prices for <span className="font-medium text-gray-200">{product.name}</span> across {summary.store_count} stores
              </p>
            </div>
        ...
        {/* Product Summary */}
        <div className="card p-6 mb-8 bg-dark-800 border border-dark-700">
        ...
        <div className="card overflow-hidden bg-dark-800 border border-dark-700">
              ...
              <tbody className="bg-dark-800 divide-y divide-dark-700">
                {prices.map((price, index) => (
                  <motion.tr
                    ...
                    className={`hover:bg-dark-700/50 ${price.is_lowest_price ? 'bg-success-900/10 border-l-4 border-success-500' : ''
                      }`}
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <div>
                          <div className="font-medium text-white">{price.store_name}</div>
                          {price.is_lowest_price && (
                            <div className="text-xs text-success-400 font-medium">Best Price</div>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <div className={`w-2 h-2 rounded-full ${price.availability === 'in_stock' ? 'bg-success-500' :
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <a
                        ...
                        className={`inline-flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${price.availability === 'out_of_stock'
        ...
        {/* Best Deal Highlight */}
        {prices.length > 0 && (
          <div className="mt-8 card p-6 bg-gradient-to-r from-success-900/30 to-primary-900/10 border border-success-500/30">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-success-900/40 rounded-full flex items-center justify-center">
                  <CheckCircle className="w-6 h-6 text-success-400" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white">Best Deal Found!</h3>
                  <p className="text-gray-400">
